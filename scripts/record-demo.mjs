...
try{
 await page.goto('https://velum.aethe.me/invoice.html',{waitUntil:'networkidle'});await scene('Review an invoice against the verified vendor record','.console-title',15);
 ...
 await page.goto('https://velum.aethe.me/invoice.html',{waitUntil:'networkidle'});await scene('Close: the payment review console','.console-title',15);
